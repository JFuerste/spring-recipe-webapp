...
import com.jfuerste.recipewebapp.services.ImageService;
...
public class ImageController {
    ...
    public void renderImage(@PathVariable String id, HttpServletResponse response) throws IOException {
        ...
        byte[] rawByteArray = new byte[command.getImage().length];
        ...
        InputStream is = new ByteArrayInputStream(rawByteArray);
